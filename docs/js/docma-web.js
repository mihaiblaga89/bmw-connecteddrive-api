...
!(function(t, e) {
    ...
    function a(t) {
        for (
            ...
            var s = e[0],
                h = e[1],
                c = e.index;
            if (((a += t.slice(r, c)), (r = c + s.length), h)) a += h[1];
            else {
                a && (i.push(a), (a = ''));
                var p = e[2],
                    u = e[3],
        ...
        return (
            ...
            t instanceof RegExp
                ...
                ? (function(t, e, n) {
                      ...
                      return s(new RegExp('(?:' + i.join('|') + ')', f(n)), e);
                  })(t, e, n)
                : (function(t, e, n) {
    ...
    var l,
        ...
        v = 'undefined' != typeof history,
        m = 'undefined' != typeof process,
        w = d && document.ontouchstart ? 'touchstart' : 'click',
        y = g && !(!window.history.location && !window.location);
    function b() {
        (this.callbacks = []),
            (this.exits = []),
            (this.current = ''),
    ...
    (b.prototype.configure = function(t) {
        ...
        this._popstate
            ...
            this._click
                ? n.document.addEventListener(w, this.clickHandler, !1)
                : d && n.document.removeEventListener(w, this.clickHandler, !1),
            this._hashbang && g && !v
                ? n.addEventListener('hashchange', this._onpopstate, !1)
                : g &&
                  n.removeEventListener('hashchange', this._onpopstate, !1);
    }),
        ...
        (b.prototype.stop = function() {
            if (this._running) {
                ...
                var t = this._window;
                this._click &&
                    t.document.removeEventListener(w, this.clickHandler, !1),
                    g &&
                        t.removeEventListener('popstate', this._onpopstate, !1),
                    g &&
                ...
                if (e.path === r.current)
                    return t
                        ...
                        : function(t) {
                              ...
                              this.stop(),
                                  (t.handled = !1),
                                  y && (n.location.href = t.canonicalPath);
                          }.call(r, e);
                e.handled = !1;
            }
            n
            ...
            if (
                ...
                if (n)
                    for (var i = 0; i < n.length; i++)
                        if (
                            n[i].nodeName &&
                            'A' === n[i].nodeName.toUpperCase() &&
                            n[i].href
                        ) {
                            e = n[i];
                            break;
                        }
                for (; e && 'A' !== e.nodeName.toUpperCase(); )
                    e = e.parentNode;
                    ...
                    if (
                        ...
                        if (
                            (this._hashbang ||
                                !this._samePath(e) ||
                                (!e.hash && '#' !== r)) &&
                            !(r && -1 < r.indexOf('mailto:')) &&
                            (o ? !e.target.baseVal : !e.target) &&
                            (o || this.sameOrigin(e.href))
                        ) {
                            var a = o
                                ? e.href.baseVal
                            ...
                            var s = a,
                                h = this._getBase();
                            0 === a.indexOf(h) && (a = a.substr(h.length)),
                                this._hashbang && (a = a.replace('#!', '')),
                                (!h ||
                                    s !== a ||
                                    (y &&
                                        'file:' ===
                                            this._window.location.protocol)) &&
                                    (t.preventDefault(), this.show(s));
                        }
                    }
                }
            }
        ...
        (R.prototype.match = function(t, e) {
            ...
            for (var a = 1, s = r.length; a < s; ++a) {
                ...
                (void 0 === c && hasOwnProperty.call(e, h.name)) ||
                    (e[h.name] = c);
            }
            return !0;
        });
...
var DocmaWeb = (function() {
    ...
    (Utils.type = function(e) {
        ...
        (Utils.notate = function(e, t) {
            if ('object' == typeof e) {
                ...
                if (i)
                    return (
                        (n = e[i]),
                        1 < r.length ? (r.shift(), Utils.notate(n, r)) : n
                    );
            }
        }),
        ...
        (Utils.getLongName = function(e) {
            ...
            if (
                ...
                e.name === r && Utils.isConstructor(e))
            )
                return n;
            var i = e.alias ? n : t;
            if (!r) return i;
        ...
        (Utils.getSymbolByName = function(e, t) {
            ...
            if ('object' === Utils.type(e)) {
                ...
                for (n = 0; n < o.length; n++)
                    if (
                        ((i = e[o[n]].documentation),
                        (l = Utils.getSymbolByName(i, t)))
                    )
                        return l;
                return null;
            }
            for (i = e, n = 0; n < i.length; n++) {
                if (
                    (r = i[n]).name === t ||
                    r.longname === t ||
                    Utils.getFullName(r) === t
                )
                    return r;
                if (r.$members && (l = Utils.getSymbolByName(r.$members, t)))
                    return l;
            }
            return null;
        }),
        ...
        (Utils.normalizeTabs = function(e) {
            ...
            return (e = e.replace(/^\s*/, '')).replace(
                /([\r\n]+)(\s+)/gm,
                function(e, t, n) {
                    return (
                        (r = n.replace(/\t/g, '  ')),
                        t +
                            (r = new Array(r.length - (r.length % 2) + 1).join(
                                ' '
                            ))
                    );
                }
    ...
    function serializer(r) {
        var i = [],
            l = [];
        return function(e, t) {
            if (2e3 < i.length) return '[Too Big Object]';
            if (0 < i.length) {
    ...
    (Utils._parseAnchorLinks = function(t, e, n) {
            ...
            var i = t || {},
                l = n.reduce(function(e, t) {
                    ...
                    return (
                        i.links &&
                            (n = n.map(function(e) {
                                return Utils._parseAnchorLinks(r, e, {
                                    linkType: i.links,
                                });
                            })),
                        e.concat(n)
            ...
            return (e || [])
                .map(function(e) {
                    if (
                        ...
                        var t = Utils._parseAnchorLinks(n, i, {
                            linkType: l.links,
                        });
                        return Utils._wrapCode(t, !1);
                    }
        ...
        (Utils._tokenize = function(e, t) {
            ...
            for (n = 0; n < e.length; n++)
                (i += e[n]),
                    (l += e[n]),
                    i.length > r && (i = i.slice(-r)),
                    '```' === i &&
                        (l = (a = !a)
                            ? (o.push(t(l.slice(0, -r), !1)), i)
                            : (o.push(t(l, !0)), ''));
            return o;
        }),
    ...
    (Utils.DOM.getOffset = function(e) {
        ...
        (Utils.DOM.scrollTo = function(e) {
            ...
            if ((e = decodeHash(e || window.location.hash || ''))) {
                var n = document.getElementById(e);
                if (n) {
                    var r = Utils.DOM.getOffset(n);
                    r && (t.scrollTop = r.top);
                }
            } else t.scrollTop = 0;
        }),
        ...
        (Utils.DOM._moveBodyStylesToHead = function() {
            var e,
                ...
                r = document.body.getElementsByTagName('style');
            for (e = 0; e < r.length; e++)
                (t = r[e]).parentNode.removeChild(t),
                    t.setAttribute(ATTR_BODY_STYLE, ''),
                    n.appendChild(t);
        });
    var _builtinURLs = {
            globals:
    ...
    Utils._getTypeExternalLink = function(e) {
        var t, n;
        for (t = 0; t < _cats.length; t++)
            if (((n = _cats[t]), 0 <= _builtins[n].indexOf(e)))
                return _builtinURLs[n] + (e || '').replace(/^([^.]*\.)/, '');
        return '';
    };
    ...
    (DocmaWeb.prototype._trigger = function(t, e) {
        ...
        (DocmaWeb.prototype.getDocmaElem = function() {
            var t = document.getElementById(this._.elementID);
            return (t =
                t ||
        ...
        (DocmaWeb.prototype._fixAnchors = function(r) {
            this.app.base &&
                setTimeout(function() {
                    var t,
                        e,
                        o = document.querySelectorAll('a[href^="#"]');
                    for (t = 0; t < o.length; t++) {
                        var n = (e = o[t]).getAttribute('href');
                        '#' === n.slice(0, 1) &&
                            1 < n.length &&
                            ((n =
                                window.location.pathname +
        ...
        (DocmaWeb.prototype._render = function(o, n) {
            ...
            dust.render(o, this, function(t, e) {
                if (t)
                    throw (r.warn('Could not load Docma partial:', o),
        ...
        (DocmaWeb.prototype.render = function(o, n) {
            ...
            if (!o.isEqualTo(this.currentRoute)) {
            ...
            return (
                this.type === DocmaWeb.Route.Type.API
                    ? ((this._docma._.documentation = this._docma.apis[
                      ...
                      (this._docma._.symbols = this._docma.apis[
                          this.name
                      ].symbols))
...
var docma = Object.freeze(
    new DocmaWeb({
                ...
                documentation: [
                    {
                        ...
                        meta: {
                            ...
                            columnno: 0,
                            path:
                                '/Users/lego/work/personal/bmw-connecteddrive-api/src/helpers',
                            code: {},
                        },
                        description: 'Handles all URLs required by BMW API',
                        kind: 'class',
                        name: 'BMWURLs',
                        longname: 'BMWURLs',
                        scope: 'global',
                        ...
                        $constructor: {
                            ...
                            description: 'Creates an instance of BMWURLs.',
                            params: [
                                { type: { names: ['*'] }, name: 'region' },
                            ],
                            memberof: 'BMWURLs',
                            name: 'BMWURLs',
                            longname: 'BMWURLs.BMWURLs',
                            kind: 'class',
                            scope: 'static',
                            $longname: 'BMWURLs',
                            $kind: 'constructor',
                    ...
                    },
                    {
                        ...
                        meta: {
                            ...
                            code: {
                                ...
                                name: 'Vehicle',
                                type: 'MethodDefinition',
                                paramnames: ['originalData', 'region'],
                            },
                            vars: { '': null },
                        },
                        undocumented: true,
                        ...
                        $longname: 'Vehicle',
                        $kind: 'constructor',
                        $docmaLink: '?api#Vehicle',
                    },
                ],
                symbols: ['BMWURLs', 'Vehicle'],
            },
        },
        app: {
        ...
        template: {
            ...
            mainHTML: 'index.html',
            options: {
                title: { label: 'API', href: '/?api' },
                navbar: {
                    menu: [
                        { label: 'Docs', iconClass: 'fas fa-book', href: './' },
                        {
                            label: 'API',
